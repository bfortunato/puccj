 ...
 */
public final class EclipseJava18Compiler extends AbstractJavaCompiler {

    private final Log log = LogFactory.getLog(EclipseJava18Compiler.class);
    private final EclipseJava18CompilerSettings defaultSettings;

    public EclipseJava18Compiler() {
        this(new EclipseJava18CompilerSettings());
    }

    public EclipseJava18Compiler( final Map<String, String> pSettings ) {
        defaultSettings = new EclipseJava18CompilerSettings(pSettings);
    }

    public EclipseJava18Compiler( final EclipseJava18CompilerSettings pSettings ) {
    ...
    public org.apache.commons.jci.compilers.CompilationResult compile(
        ...
        final Map<String, String> settingsMap = new EclipseJava18CompilerSettings(pSettings).toNativeSettings();
...
//                log.debug("isPackage parentPackageName=" + result.toString() + " packageName=" + new String(packageName));
        ...
        final org.eclipse.jdt.internal.compiler.Compiler compiler = new Compiler(nameEnvironment, policy, new CompilerOptions(settingsMap), compilerRequestor, problemFactory);
    ...
    public JavaCompilerSettings createDefaultSettings() {
        return new EclipseJava18CompilerSettings(defaultSettings);
    }
}
